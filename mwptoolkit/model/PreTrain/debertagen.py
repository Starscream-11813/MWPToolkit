...
class DeBERTaGen(nn.Module):
    """
    Reference:
        Devlin et al. "BERT: Pre-training of Deep Bidirectional Transformers for Language Understanding".
    """
    def __init__(self, config, dataset):
        super(DeBERTaGen, self).__init__()
        ...
        self.encoder = DebertaModel.from_pretrained(self.pretrained_model_path)
    ...
    def forward(self, seq, target=None, output_all_layers=True) -> Tuple[torch.Tensor, torch.Tensor, Dict[str, Any]]:
        """
        ...
        # print(token_logits, symbol_outputs, decoder_layer_outputs)
        model_all_outputs = {}
    ...
    def calculate_loss(self, batch_data:dict) -> float:
        ...
        token_logits, _, model_outputs = self.forward(seq, target)
        ...
        return self.loss.get_loss(), model_outputs
    ...
    def encoder_forward(self, seq, output_all_layers=True):
    ...
    def decoder_forward(self, encoder_outputs, source_padding_mask, target=None, output_all_layers=True):
